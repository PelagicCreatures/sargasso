var SargassoModule = (function (exports) {
	...
	const ifDefined = directive((value) => (part) => {
	    ...
	    if (value === undefined && part instanceof AttributePart) {
	        ...
	        if (previousValue !== undefined || !previousValues$4.has(part)) {
	    ...
	    previousValues$4.set(part, value);
	});
	...
	const guard = directive((value, f) => (part) => {
	    ...
	    if (Array.isArray(value)) {
	        ...
	        (value !== undefined || previousValues$3.has(part))) {
	    ...
	    previousValues$3.set(part, Array.isArray(value) ? Array.from(value) : value);
	});
	...
	**/
	...
	class Sargasso {
		...
		*************************************************/
		...
		observableStart (id, data, property) {
		...
		render () {
			if (this.template) {
				litHTML.render(this.template(JSON.parse(JSON.stringify(this.templateArgs || {}))), this.element);
			}
		}
